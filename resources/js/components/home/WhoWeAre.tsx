        ...
        >
            <div className="w-[45%]">
                ...
                <p className="mt-5 pr-4 text-lg">
                    Titum (Pvt) Ltd. is established in 2018 by a team of young expert software professionals. We are enable to out clients to address
                    challenges and enhance their business by designing top notch software solutions tailored to their needs...
                </p>
