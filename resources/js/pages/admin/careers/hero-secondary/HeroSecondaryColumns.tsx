...
export const heroSecondaryContentColumns: ColumnDef<ICareerHeroSecondaryContent>[] = [
    {
        accessorKey: 'content',
        header: () => <div className="">{TABLE_COLUMN_NAMES.CONTENTS}</div>,
    },
    {
            ...
            return (
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        <DropdownMenuItem
                            // onClick={() => handleRowAction(actionOptionsArr[0].label, row?.original)}
